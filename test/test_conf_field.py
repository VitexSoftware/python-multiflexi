...
class TestConfField(unittest.TestCase):
    """ConfField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfField:
        """Test ConfField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfField`
        """
        model = ConfField()
        if include_optional:
            return ConfField(
