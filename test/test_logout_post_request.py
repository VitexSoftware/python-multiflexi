...
class TestLogoutPostRequest(unittest.TestCase):
    """LogoutPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogoutPostRequest:
        """Test LogoutPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogoutPostRequest`
        """
        model = LogoutPostRequest()
        if include_optional:
            return LogoutPostRequest(
                token = ''
            )
        else:
            return LogoutPostRequest(
    ...
    def testLogoutPostRequest(self):
        """Test LogoutPostRequest"""
