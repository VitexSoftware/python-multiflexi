...
class TestAppEnvironmentValue(unittest.TestCase):
    """AppEnvironmentValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppEnvironmentValue:
        """Test AppEnvironmentValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppEnvironmentValue`
        """
        model = AppEnvironmentValue()
        if include_optional:
            return AppEnvironmentValue(
                type = 'text',
                description = '',
                defval = '',
                required = True
    ...
    def testAppEnvironmentValue(self):
        """Test AppEnvironmentValue"""
