...
class TestSetUserRolesRequest(unittest.TestCase):
    """SetUserRolesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetUserRolesRequest:
        """Test SetUserRolesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetUserRolesRequest`
        """
        model = SetUserRolesRequest()
        if include_optional:
    ...
    def testSetUserRolesRequest(self):
        """Test SetUserRolesRequest"""
