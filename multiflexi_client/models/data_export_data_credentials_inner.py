...
class DataExportDataCredentialsInner(BaseModel):
    """
    DataExportDataCredentialsInner
    """ # noqa: E501
    credential_id: Optional[StrictInt] = None
    credential_name: Optional[StrictStr] = None
    company_id: Optional[StrictInt] = None
    credential_type: Optional[StrictStr] = None
    note: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["credential_id", "credential_name", "company_id", "credential_type", "note"]
