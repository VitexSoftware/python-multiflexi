...
class SetUserRolesRequest(BaseModel):
    ...
    SetUserRolesRequest
    """ # noqa: E501
    roles: List[StrictStr] = Field(description="List of RBAC role names to assign")
    assigned_by: Optional[StrictInt] = Field(default=None, description="Optional user ID of the person performing the assignment")
    __properties: ClassVar[List[str]] = ["roles", "assigned_by"]
