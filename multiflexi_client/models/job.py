...
class Job(BaseModel):
    ...
    task_id: Optional[StrictInt] = Field(default=None, description="FK to the Task this job belongs to")
    app_version: Optional[StrictStr] = 'n/a'
    __properties: ClassVar[List[str]] = ["id", "app_id", "begin", "end", "company_id", "exitcode", "stdout", "stderr", "launched_by", "env", "command", "schedule", "executor", "runtemplate_id", "task_id", "app_version"]
