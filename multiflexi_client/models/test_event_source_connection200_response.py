...
class TestEventSourceConnection200Response(BaseModel):
    """
    TestEventSourceConnection200Response
    """ # noqa: E501
    reachable: Optional[StrictBool] = Field(default=None, description="Whether the adapter database is reachable")
    message: Optional[StrictStr] = Field(default=None, description="Test result message")
    __properties: ClassVar[List[str]] = ["reachable", "message"]
