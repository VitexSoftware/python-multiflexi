...
class User(BaseModel):
    ...
    last_modifier_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "enabled", "settings", "email", "firstname", "lastname", "password", "login", "DatCreate", "DatSave", "last_modifier_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_modifier_id": obj.get("last_modifier_id")
        })
        return _obj
