...
class DataExportStatusResponseExportsInner(BaseModel):
    """
    DataExportStatusResponseExportsInner
    """ # noqa: E501
    message: StrictStr = Field(description="Export request description")
    requested_at: datetime = Field(description="ISO 8601 timestamp when the export was requested")
    __properties: ClassVar[List[str]] = ["message", "requested_at"]
