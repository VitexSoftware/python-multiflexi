...
class ConfField(BaseModel):
    """
    ConfField
    """ # noqa: E501
    id: Optional[StrictInt] = None
    app_id: Optional[StrictInt] = None
    keyname: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    category: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default='', description="Configuration option category: API, Database, Behavior, Security or Other")
    description: Optional[StrictStr] = None
    defval: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "app_id", "keyname", "type", "category", "description", "defval"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['text', 'number', 'date', 'email', 'password', 'checkbox']):
            raise ValueError("must be one of enum values ('text', 'number', 'date', 'email', 'password', 'checkbox')")
        return value
