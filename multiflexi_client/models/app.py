...
class App(BaseModel):
    ...
    topics: Optional[StrictStr] = Field(default=None, description="Comma-separated list of topics/tags (deprecated — use tags)")
    ...
    deffile: Optional[StrictStr] = Field(default=None, description="Path to the application definition JSON file")
    helmchart: Optional[StrictStr] = Field(default=None, description="URI or local path to Helm chart")
    ...
    tags: Optional[StrictStr] = Field(default=None, description="Comma-separated list of tags (there is no structured Tag entity in the current implementation)")
    status: Optional[StrictStr] = Field(default=None, description="App status in the store")
    __properties: ClassVar[List[str]] = ["id", "enabled", "image", "name", "description", "executable", "DatCreate", "DatUpdate", "setup", "cmdparams", "deploy", "homepage", "requirements", "ociimage", "version", "code", "uuid", "topics", "resultfile", "artifacts", "deffile", "helmchart", "environment", "exitCodes", "tags", "status"]
