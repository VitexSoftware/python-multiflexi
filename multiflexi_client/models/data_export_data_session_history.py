...
class DataExportDataSessionHistory(BaseModel):
    """
    DataExportDataSessionHistory
    """ # noqa: E501
    note: Optional[StrictStr] = None
    current_session_info: Optional[DataExportDataSessionHistoryCurrentSessionInfo] = None
    __properties: ClassVar[List[str]] = ["note", "current_session_info"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of current_session_info
        if self.current_session_info:
            _dict['current_session_info'] = self.current_session_info.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "note": obj.get("note"),
            "current_session_info": DataExportDataSessionHistoryCurrentSessionInfo.from_dict(obj["current_session_info"]) if obj.get("current_session_info") is not None else None
        })
        return _obj
