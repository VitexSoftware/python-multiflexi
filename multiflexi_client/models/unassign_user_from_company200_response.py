...
class UnassignUserFromCompany200Response(BaseModel):
    """
    UnassignUserFromCompany200Response
    """ # noqa: E501
    company_id: Optional[StrictInt] = None
    user_id: Optional[StrictInt] = None
    deleted: Optional[StrictInt] = Field(default=None, description="Number of rows removed (0 if user was not assigned)")
    __properties: ClassVar[List[str]] = ["company_id", "user_id", "deleted"]
