...
class ListCompanyUsers200ResponseInner(BaseModel):
    """
    ...
    role: Optional[StrictStr] = Field(default='viewer', description="Access role in the company (e.g. viewer, manager, admin)")
    created_at: Optional[datetime] = Field(default=None, description="Timestamp when the assignment was created")
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["company_id", "user_id", "role", "created_at", "user"]
