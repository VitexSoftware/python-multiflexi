...
class DataExportStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool
    exports: List[DataExportStatusResponseExportsInner]
    __properties: ClassVar[List[str]] = ["success", "exports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exports": [DataExportStatusResponseExportsInner.from_dict(_item) for _item in obj["exports"]] if obj.get("exports") is not None else None
        })
        return _obj
