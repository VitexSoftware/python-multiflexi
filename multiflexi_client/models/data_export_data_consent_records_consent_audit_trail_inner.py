...
class DataExportDataConsentRecordsConsentAuditTrailInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "consent_type", "old_value", "new_value", "timestamp", "ip_address"]
