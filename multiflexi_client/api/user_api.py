...
class UserApi:
    ...
    def get_user_by_id(
        self,
        user_id: Annotated[StrictInt, Field(description="ID of User to return")],
        ...
        :param user_id: ID of User to return (required)
        :type user_id: int
    ...
    def _get_user_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/user/{userId}.{suffix}',
    ...
    def set_user_by_id(
        self,
        user_id: Annotated[Optional[StrictInt], Field(description="ID of User to return")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="maximum number of results to return")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._set_user_by_id_serialize(
            user_id=user_id,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def set_user_by_id_with_http_info(
        self,
        user_id: Annotated[Optional[StrictInt], Field(description="ID of User to return")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="maximum number of results to return")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def set_user_by_id_without_preload_content(
        self,
        user_id: Annotated[Optional[StrictInt], Field(description="ID of User to return")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="maximum number of results to return")] = None,
        _request_timeout: Union[
