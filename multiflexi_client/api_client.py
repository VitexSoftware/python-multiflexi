...
from multiflexi_client.configuration import Configuration
from multiflexi_client.api_response import ApiResponse, T as ApiResponseT
import multiflexi_client.models
from multiflexi_client import rest
from multiflexi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(multiflexi_client.models, klass)
